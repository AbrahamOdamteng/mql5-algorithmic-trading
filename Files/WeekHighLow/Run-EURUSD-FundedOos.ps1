...
$iniFiles = @(
  'EURUSD_Funded_Pass1313_OOS.ini',
  'EURUSD_Funded_Pass2396_OOS.ini',
  'EURUSD_Funded_Pass2473_OOS.ini',
  'EURUSD_Funded_Pass2303_OOS.ini',
  'EURUSD_Funded_Pass3441_OOS.ini',
  'EURUSD_Funded_Pass3634_OOS.ini',
  'EURUSD_Funded_Pass3044_OOS.ini'
)
